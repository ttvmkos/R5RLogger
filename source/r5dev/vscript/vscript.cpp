...
void Script_RegisterServerFunctions(CSquirrelVM* s)
{
	...
	//for logging
	s->RegisterFunction("LogEvent", "Script_LogEvent", "Logs event with GameEvent,DirectoryCheck,Encryption", "void", "string, bool, bool", &VScriptCode::SHARED::LogEvent);
	s->RegisterFunction("SetMatchID", "Script_SetMatchID", "Sets the match ID", "void", "", &VScriptCode::SHARED::SetMatchID);
	s->RegisterFunction("SQMatchID", "Script_SQMatchID", "Gets the match ID", "string", "", &VScriptCode::SHARED::SQMatchID);
	s->RegisterFunction("stopLogging", "Script_stopLogging", "Stops the logging thread, writes remaining queued messages", "void", "bool", &VScriptCode::SHARED::stopLogging);
	s->RegisterFunction("isLogging", "Script_isLogging", "Checks if the log thread is running", "bool", "", &VScriptCode::SHARED::isLogging);

	// for debugging the sqvm
	s->RegisterFunction("sqprint", "Script_sqprint", "Prints string to console window from sqvm", "string", "string", &VScriptCode::SHARED::sqprint);
	s->RegisterFunction("testbool", "Script_testbool", "Prints string to console window from sqvm", "bool", "bool", &VScriptCode::SHARED::testbool);
